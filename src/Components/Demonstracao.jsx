...
//   if (isSubmitted) {
//     return (
//       <div className="min-h-screen bg-gradient-to-br from-[#1B4B96] to-[#42B7E9] flex items-center justify-center px-4 sm:px-6 lg:px-8">
...
//   return (
//     <div className="min-h-screen bg-gradient-to-br from-[#1B4B96] to-[#42B7E9]">
...
//         </div>
//       </main>
//       <footer className="bg-white py-4 text-center text-gray-600 text-sm sticky bottom-0 w-full">
