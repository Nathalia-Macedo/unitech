        ...
        <div className="container mx-auto px-4">
          <div className="grid gap-8 lg:grid-cols-2 items-center">
            <div className="max-w-2xl space-y-6">
              ...
              <button className="inline-flex bg-gradient-to-r from-[#1B4B96] to-[#42B7E9] text-white hover:from-[#42B7E9] hover:to-[#1B4B96] text-lg px-8 py-4 rounded-full shadow-lg hover:shadow-xl transition-all font-medium font-inter">
              <Link to="/solicitar-demonstracao">  Solicite Uma Demonstração Agora!</Link>
              </button>
            </div>
